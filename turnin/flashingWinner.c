...
enum DSPLY_States {DS_start, DS_game, DS_score, DS_blank, DS_firework, DS_winner, DS_winner2};
...
int DSPLY_Tick(int state) {
	...
	static unsigned char periodCounter = 1000;
	static unsigned char flashCounter = 3;
	unsigned char tmpD = (~PIND & 0x0C);
	PORTB = lScore;
